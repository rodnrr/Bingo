...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      sessionStorage.setItem('risebay_invite_code', code.trim().toUpperCase())
      localStorage.setItem('risebay_invite_code', code.trim().toUpperCase())
  ...
  return (
    <Container className="max-w-md">
      <Card>
        <h1 className="text-2xl font-bold">Join RiseBay</h1>
