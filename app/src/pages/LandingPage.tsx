...
const POINTS = [
  ...
  },
  {
    ...
    body: 'Checkout is hosted by Stripe. RiseBay stores your orders — never your card or bank numbers.',
  },
]
    ...
    <Container>
      <section className="py-12 text-center sm:py-20">
        <h1 className="mx-auto max-w-2xl text-4xl font-bold tracking-tight sm:text-5xl">
          ...
          <span className="text-primary-600">door policy</span>
        </h1>
        <p className="mx-auto mt-4 max-w-xl text-lg text-gray-600 dark:text-slate-400">
          RiseBay is a buy-and-sell marketplace you can only join with an invite from a
          member. List what you have, sell it to people who were vouched for, get paid to
          your bank.
        </p>
