...
Open http://localhost:5173. You should see the RiseBay landing page.
...
1. Sign up at [cloudflare.com](https://cloudflare.com) → **Workers & Pages** →
...
4. Deploy. You get a `risebay-xyz.pages.dev` URL.
